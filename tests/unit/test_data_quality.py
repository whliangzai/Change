...
def test_quality_gate_rejects_zero_price() -> None:
    row = {
        "symbol": "600000.SH", "trade_date": date(2024, 1, 2),
        "raw_open": "0", "raw_high": "10", "raw_low": "10", "raw_close": "10",
        "adjusted_open": "10", "adjusted_high": "10", "adjusted_low": "10", "adjusted_close": "10",
        "volume": "0", "amount": "0", "adjust_factor": "1",
    }
...
def test_importer_hash_is_canonical_across_column_order_and_decimal_format(tmp_path) -> None:
    ...
    assert canonical_content_hash([{"trade_date": date(2024, 1, 2), "amount": Decimal("10.00"), "empty": None}]) == canonical_content_hash([{"empty": None, "amount": 10.0, "trade_date": "2024-01-02"}])

...
EXPECTED_TABLES = {
    "user_account", "role", "user_role", "data_source", "data_batch", "trade_calendar",
    "security", "security_status_history", "industry_membership_history", "daily_bar",
    "adjustment_factor", "rule_config_version", "cost_config_version", "strategy_version",
    "signal_snapshot", "backtest_run", "run_stage", "portfolio_snapshot", "position_snapshot",
    "order_plan", "execution_record", "ledger_entry", "performance_metric", "report_artifact",
    "daily_report", "job_run", "audit_event", "system_alert",
}
